...
namespace SolariPDV.Models.Comercial
{
    ...
    public class ItemPedidoModel : ViewModelBase
    {
        ...
        public long ID_CARACMAT { get; set; }
        ...
        public string DT_INICIOCOZINHA { get; set; }
        public string DT_FIMCOZINHA { get; set; }
        public Boolean  BO_RELACIONADO { get; set; }
        public double VL_ADICIONALCARAC { get; set; }
        public long QT_CARAC { get; set; }

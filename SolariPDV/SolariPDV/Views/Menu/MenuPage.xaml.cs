...
namespace SolariPDV.Views.Menu
{
    ...
    public partial class MenuPage : ContentPage
    {
        ...
        public MenuPage()
        {
            ...
            menuItems = new List<HomeMenuItem>
            {
                ...
                new HomeMenuItem {Id = MenuItemType.Estoque, Title="Produtos e Estoque" },
        ...
        private async void GetDadosInicio()
        {
            try
            {
                ...
                await loginLogic.GetHostName(App.current.sdsUsuario);
                ...
                App.current.bboDashboard = menuModel.BO_VERDASHBOARD == "T" ? true : false;
            }
            catch
            {
